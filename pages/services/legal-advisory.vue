    ...
    <UiIntro bg-image="https://lh3.googleusercontent.com/aida-public/AB6AXuCDseSOT3mOT4qS4gX__-9DxF7GHt1hEjDWzMdt0PoEgPcgWGWwWgeXvRe4xE3ur2kX7fccXirstK97YhT84Lmg-PX7bVTUFLV9vEHmHZkxZ7VFYKMnf_3Ww8EfIOndCK4UZNIHn5LBH2KGUhoN4WftE31YSXfygb8472kXzEwb0yLzvUxH1JhuPiAFYD9ULPiXQ8XuVZl5xqk09zpPgrmzrFkWWTrT68lMOVOEiTv-xT7mT9GA7dqjX2h7EaSy0sUXIJZJGykzwWQ">
      <template #header>
        <UiTitle size="md">
          ...
          <template #title>
            <h1 class="text-display-xl font-serif text-on-primary leading-none">Právní poradenství</h1>
          </template>
        </UiTitle>
      </template>

      <template #description>
        <p class="text-body-lg text-on-primary-container max-w-xl mt-stack-md opacity-90">Právní poradenství u nás není jednorázová služba, ale dlouhodobá spolupráce postavená na důvěře, diskrétnosti a profesionalitě. Proto ke každému klientovi přistupujeme individuálně a s respektem k jeho situaci i soukromí.</p>
      </template>
    </UiIntro>
            ...
            >
              <div class="order-2 md:order-1 space-y-stack-md">
                <p class="text-body-md text-on-surface-variant">
                  Specializujeme se především na oblasti, které přímo souvisejí
                  s vaším majetkem a jeho správou – smluvní agenda, převody
                  nemovitostí, nastavení vlastnických struktur, investiční
                  vztahy nebo ochrana majetku. Neřešíme trestní právo ani
                  obecnou právní agendu, ale soustředíme se na to, kde dokážeme
                  přinést skutečnou hodnotu a odbornost. Díky tomu víte, že
                  pracujete s odborníky, kteří se pohybují ve svém oboru a
                  rozumí jeho detailům.
                </p>
                <p class="text-body-md text-on-surface-variant">
