...
<template>
  ...
  >
    ...
    ></div>
    <div v-if="bgImage" class="absolute inset-0 hero-gradient"></div>
    <div v-else class="absolute inset-0 bg-primary-900"></div>

    <div class="relative z-10 max-w-7xl mx-auto px-gutter w-full py-24">
      <span
        v-if="eyebrow"
