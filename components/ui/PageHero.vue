...
<template>
  <section
    class="relative max-w-7xl mx-auto px-gutter pt-stack-lg pb-section-gap overflow-hidden"
  >
    <div
      class="pointer-events-none absolute -top-24 -right-16 h-96 w-96 rounded-full bg-secondary-fixed/15 blur-3xl"
    ></div>
    <div
      class="pointer-events-none absolute -bottom-12 -left-12 h-64 w-64 rounded-full bg-primary-300/10 blur-3xl"
    ></div>
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-stack-lg items-end">
      <div class="lg:col-span-8">
        ...
        <h1
          class="text-display-xl font-serif text-primary-900 mb-stack-md leading-none"
          v-html="title"
        />
        <div
          class="h-0.5 w-20 rounded-full mb-stack-md bg-gradient-to-r from-[#745b26] via-[#e4c283] to-[#745b26] shadow-md"
        ></div>
        <slot />
      </div>
